                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      16.verticalSpace(),
                      Text(
                        AppString.failedToLoadEvaluation.tr,
                        style: Theme.of(context).textTheme.titleLarge?.copyWith(
                              fontWeight: FontWeight.w800,
                            ),
                      ),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          evaluation == null ? AppString.noData.tr : evaluation.periodLabel,
                                          style: Theme.of(context).textTheme.titleLarge?.copyWith(
                                                fontWeight: FontWeight.w800,
                                              ),
                                        ),
                                        ...
                                        Text(
                                          evaluation == null
                                              ? AppString.evaluationNotFetched.tr
                                              : '${AppString.totalScore.tr}: ${evaluation.totalScore}',
                                          style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                                                color: AppColor.darkGrey,
                                              ),
                                        ),
                                        ...
                                        Text(
                                          evaluation == null
                                              ? ''
                                              : '${AppString.evaluationId.tr}: ${evaluation.id} • ${AppString.employee.tr}: ${evaluation.employeeId}',
                                          style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                                color: AppColor.black,
                                                fontWeight: FontWeight.w600,
                                              ),
